...
SECRET_KEY = 'django-insecure-^$e*8=u$2se$k^v=it+_e7guto0@*nn^!%nfl(qp51oil)%0w*'
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'bastiong3@gmail.com'
EMAIL_HOST_PASSWORD = 'ubsv cfeo hrba gyik'
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Bem vindo ao Sistema Metrius",
